...
const float NPC_RANGED_PATH_MOVER_BOX_BUFFER = 10.0f;
...
const float NPC_RANGED_RETREAT_EXTRA_DISTANCE = 100.0f;
const float NPC_RANGED_RETREAT_POINT_CHECK_TIME = 0.25f;
const int   NPC_RANGED_RETREAT_ANGLE_COUNT = 7;
const float NPC_RANGED_RETREAT_ANGLES[NPC_RANGED_RETREAT_ANGLE_COUNT] = {
    0.0f, 0.5235988f, -0.5235988f,
